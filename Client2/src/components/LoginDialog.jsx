              ...
              <div className="hud-panel relative overflow-hidden">
                ...
                <div className="p-8">
                  ...
                  <motion.button
                    ...
                    className="w-full flex items-center justify-center gap-3 bg-[#5865F2] hover:bg-[#4752C4] text-white font-mono text-xs uppercase tracking-wider py-3 px-6 border border-[#5865F2] hover:border-[#4752C4] transition-all relative overflow-hidden"
                  >
                    {/* Corner accents */}
