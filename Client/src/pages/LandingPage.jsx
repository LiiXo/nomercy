...
const LandingPage = () => {
  ...
  const getText = (key) => {
    const texts = {
      ...
      hardcoreDesc: { fr: 'Sans HUD. Dégâts réalistes. Pour les vrais.', en: 'No HUD. Realistic damage. For the real ones.', it: 'Senza HUD. Danni realistici. Per i veri.', de: 'Kein HUD. Realistischer Schaden. Für die Echten.' },
