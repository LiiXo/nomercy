...
const ModeSelection = () => {
  ...
  const getText = (key) => {
    const texts = {
      ...
      hardcoreDesc: { fr: 'Sans HUD. Dégâts réalistes. Pour les vrais guerriers.', en: 'No HUD. Realistic damage. For real warriors.', it: 'Senza HUD. Danni realistici. Per veri guerrieri.', de: 'Kein HUD. Realistischer Schaden. Für echte Krieger.' },
      cdl: { fr: 'CDL', en: 'CDL', it: 'CDL', de: 'CDL' },
      cdlDesc: { fr: 'Règles officielles de la Call of Duty League.', en: 'Official Call of Duty League rules.', it: 'Regole ufficiali della Call of Duty League.', de: 'Offizielle Call of Duty League Regeln.' },
