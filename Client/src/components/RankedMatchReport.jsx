...
import { 
  ...
  ChevronRight, Star, Shield, Crown, Medal, Flame, ArrowRight, AlertTriangle
} from 'lucide-react';
          ...
          <div className="mt-8 flex flex-col sm:flex-row gap-3 justify-center">
            ...
            <button
              onClick={() => {
                ...
                if (mId) {
                  navigate(`/my-disputes`, { state: { openDisputeFor: mId, matchType: 'ranked' } });
                }
              }}
              className="px-6 py-3 rounded-xl font-semibold text-orange-400 border-2 border-orange-500/50 bg-orange-500/10 hover:bg-orange-500/20 transition-all flex items-center justify-center gap-2"
            >
