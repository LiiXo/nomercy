...
const AdminApplication = ({ 
  ...
  return (
    <div className="space-y-4 sm:space-y-6">
      ...
      {/* Ranked Settings - Redirect to Config tab */}
      <div className="bg-dark-800/50 border border-orange-500/30 rounded-xl p-4 sm:p-6">
        ...
        <div className="bg-amber-500/10 border border-amber-500/30 rounded-lg p-4">
          ...
          <p className="text-amber-300/80 text-xs">
            Toutes les configurations du mode classé (récompenses, points par rang, etc.) se trouvent dans l'onglet <strong className="text-white">Config</strong> :
          </p>
          <ul className="mt-2 space-y-1 text-xs text-gray-400">
            <li>• <strong className="text-orange-400">Récompenses Mode Classé</strong> : Points victoire/défaite, gold, XP par mode de jeu</li>
            <li>• <strong className="text-red-400">Points Perdus par Rang</strong> : Points perdus selon le rang du joueur (Bronze → Champion)</li>
          </ul>
        </div>
